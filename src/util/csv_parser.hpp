...
public:
	 ...
	 */
	void parse(const std::string & filename, char sep = ',', char quote = '\"', bool trim = true);
...
private:
	...
	void parse_row_(const std::string & row, std::size_t row_id, char sep, char quote, bool trim);

};

}

#include "csv_parser.ipp"
